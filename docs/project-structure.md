...
ES260523874-cloud-ops-portfolio/
  ...
  web-dashboard/         README スクリーンショット用 UI
...
Terraform と mock config により、AWS 構築思想を credential なしで説明する。

## screenshots

Playwright により `dashboard.png`、`request-list.png`、`request-detail.png`、`batch-result.png`、`logs-or-tests.png` を生成する。
